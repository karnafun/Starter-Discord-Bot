  ...
  async execute(interaction) {
    ...
    streams.forEach(stream => {
      fields.push(
        ...
        {
          name: 'Url', value: `[Watch Stream](${stream.url},)`, inline: true
        },
        {
          name: 'Game', value: stream.game, inline: true
        },
        { name: '\u200B', value: '\u200B' }
      )
    });
    const embed = new MessageEmbed()
      ...
      .setColor('#3355aa')
      .setTimestamp()
      .setFooter({ text: 'Want to ask new bot features? contact me at: danaidor@gmail.com', iconURL: 'https://pbs.twimg.com/media/EXu4kkYUMAE5klg.png' });
